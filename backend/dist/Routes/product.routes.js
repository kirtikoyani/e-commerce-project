...
productRouter.post("/product", authHelper_1.authenticateUser, product_controller_1.createProduct);
productRouter.put("/product/:id", authHelper_1.authenticateUser, product_controller_1.updateProduct);
